...
def read_file():
	...
	f = open("stateless_firewall_64bytes_100000flows.txt")
	...
	f = open("cb_firewall_64bytes_100000flows.txt")
...
def main():
	...
	plt.savefig("firewall_throughput_latency_cdf.pdf", bbox_inches='tight', pad_inches=0)
	plt.show()
