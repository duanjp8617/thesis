...
def draw():
	...
	netstar=[8.156362,5.296005,3.197825,2.298331]

#	opennf=map(float,opennf)
	callback=[8.5,5.35,3.4,2.43]
...
#	nfa=map(float,nfa)
	...
	plt.ylabel("Throughtput(Mpkts/s)", fontsize=20, style='normal', color='black')
	plt.savefig("read_write_throughput.pdf", bbox_inches='tight', pad_inches=0)
	plt.show()
